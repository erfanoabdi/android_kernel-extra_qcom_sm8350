...
static void sps_debugfs_init(void)
{
	...
	debugfs_create_u8("reg_dump_option", 0664,
						dent, &reg_dump_option);

	debugfs_create_u32("testbus_sel", 0664,
						dent, &testbus_sel);

	debugfs_create_u32("bam_pipe_sel", 0664,
						dent, &bam_pipe_sel);

	debugfs_create_u32("desc_option", 0664,
						dent, &desc_option);
	...
	debugfs_create_u32("log_level_sel", 0664,
						dent, &log_level_sel);
